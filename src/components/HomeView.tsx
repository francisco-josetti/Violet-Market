    ...
    <div className="flex flex-col gap-y-24 pb-24 animate-fade-in">
      <section className="relative w-full h-[640px] md:h-[760px] flex items-center justify-center overflow-hidden px-6 md:px-16">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center space-y-8 px-4">
          <h1 className="font-hanken text-4xl sm:text-5xl md:text-6.5xl font-extrabold text-foreground leading-tight tracking-tight">
            Descubra o Futuro do{' '}
            <span className="text-primary">Comércio</span>
          </h1>
          <p className="font-sans text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
            ...
            <button
              ...
              className="bg-accent border border-border px-8 py-4 rounded-xl font-mono text-sm tracking-wide font-medium text-foreground hover:bg-muted hover:border-primary transition-all duration-300 cursor-pointer"
      ...
      <section className="w-full max-w-7xl mx-auto px-6 md:px-16">
        <div className="flex items-end justify-between mb-8 border-b border-border pb-4">
          <h2
            className="font-hanken text-2xl sm:text-3xl font-bold text-foreground tracking-tight"
          ...
          <Link
            href={routes.catalog}
            className="font-mono text-xs sm:text-sm text-primary hover:text-primary transition-colors flex items-center gap-1 group cursor-pointer"
            id="view-all-new"
          >
            Ver tudo
            <ArrowRight
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {newArrivals.map((product) => (
            <div
              key={product.id}
              className="group flex flex-col bg-card rounded-xl overflow-hidden border border-border hover:border-primary/30 transition-all duration-500 relative shadow-lg cursor-pointer"
            ...
            >
              <div className="aspect-square w-full bg-muted relative overflow-hidden">
                ...
                />
                {product.bannerText && (
                  <div className="absolute top-3 left-3 bg-primary/10 border border-primary/20 px-3 py-1 rounded-full">
              ...
              <div className="p-4 flex flex-col gap-2 flex-grow bg-card z-10 relative">
                <h3 className="font-hanken text-base sm:text-lg text-foreground line-clamp-1 group-hover:text-primary transition-colors">
                  {product.name}
                </h3>
                <p className="font-sans text-xs sm:text-sm text-muted-foreground line-clamp-2 md:h-10 leading-normal">
                  {product.description}
                </p>
                <div className="mt-auto flex items-center justify-between pt-3 border-t border-border">
                  <span className="font-mono text-sm sm:text-base font-semibold text-foreground font-semibold">
                    R${' '}
      ...
      >
        <h2 className="font-hanken text-2xl sm:text-3xl font-bold text-foreground mb-8 border-b border-border pb-4">
          Categorias em Destaque
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:h-[600px]">
          <div
            onClick={() => handleBentoClick('Hardware')}
            className="md:col-span-2 md:row-span-2 relative rounded-2xl overflow-hidden group cursor-pointer shadow-md h-[320px] md:h-auto border border-border hover:border-primary/20 transition-all duration-500"
            id="bento-hardware"
          >
            <img
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-8 z-10 w-full flex flex-col space-y-2">
              ...
              <h3 className="font-hanken text-2xl md:text-3xl font-bold text-foreground">
          ...
          <div
            ...
            className="relative rounded-2xl overflow-hidden group bg-muted border border-border hover:border-primary/20 transition-all duration-500 flex flex-col justify-end p-6 h-[200px] md:h-auto cursor-pointer"
            id="bento-wearables"
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-hanken text-xl md:text-2xl font-semibold text-foreground">
                Integração Pessoal
              </h3>
            </div>
          </div>
      ...
      <section className="w-full max-w-7xl mx-auto px-6 md:px-16" id="promotional-banner">
        <div className="relative w-full rounded-2xl overflow-hidden bg-accent border border-primary/20 flex flex-col md:flex-row items-center justify-between p-8 md:p-12 gap-8 shadow-lg">
          ...
          <div className="relative z-10 flex flex-col space-y-2 max-w-xl text-center md:text-left">
            ...
            <h2 className="font-hanken text-2xl sm:text-3xl font-bold text-foreground">
              Vantagem Tática
            </h2>
          ...
          <div className="relative z-10 flex flex-col items-center gap-2 shrink-0">
            <button
              ...
              className="bg-muted border border-border border-dashed px-8 py-3.5 rounded-xl font-mono text-sm tracking-[0.2em] font-bold text-foreground select-all cursor-pointer hover:border-primary hover:text-primary transition-all duration-300 hover:scale-103 active:scale-97 text-center w-full sm:w-auto"
            ...
            <span className="font-sans text-xs text-muted-foreground select-none">
              {copiedCoupon ? (
