...
export default function SocialAuthButtons({
  ...
  const label = mode === 'login' ? 'Entrar' : 'Cadastrar';
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-on-surface text-background font-sans text-sm font-medium hover:opacity-90 transition-all duration-200 cursor-pointer active:scale-[0.98]"
        id="auth-apple-btn"
      >
        <AppleIcon />
        {label} com Apple
